...
public static class DeviceSerializationExtensions {
	...
	public static SerializedScreen Serialize(this Screen screen, IPluginQuery pluginQuery) {
		return new SerializedScreen {
			Name = screen.Name,
	...
	public static DeviceConfig Serialize(this Core core, IPluginQuery pluginQuery) {
	...
	public static async Task<TriggerInstance?> Deserialize(this SerializedTrigger serializedTrigger,
		...
		instance.AddActions(
			serializedTrigger.Actions.Select(sA => sA.Deserialize(pluginQuery))
	...
	public static async Task<ScreenItem?> Deserialize(this SerializedScreenItem serializedItem, Input input,
		IPluginQuery pluginQuery
	) {
	...
	public static async Task<Screen?> Deserialize(this SerializedScreen serializedScreen, Core core,
		...
		var screen = core.NewScreen(serializedScreen.Name, serializedScreen.CanWrite);
	...
	public static async Task LoadConfigIntoCore(this CoreImpl core, DeviceConfig config, IPluginQuery pluginQuery) {
		...
		lock (core._screenStack) {
			...
			foreach (var screen in screens) core._screenStack.Push(screen);
		}
