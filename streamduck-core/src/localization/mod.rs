...
impl LocalizationManager {
    ...
    pub async fn get(&self, language_tag: &str) -> Option<Arc<Localization>> {
        self.localizations.read().await.get(language_tag).cloned()
    }
    ...
    pub async fn language_map(&self) -> HashMap<String, Arc<Localization>> {
        self.localizations.read().await.clone()
    }
    ...
    pub async fn translation_map(&self) -> HashMap<String, HashMap<String, String>> {
        join_all(
            self.language_map()
                .await
                .into_iter()
                .map(|(k, l)| async move { (k, l.translation_map().await) }),
        )
        .await
        .into_iter()
        .collect()
    ...
    pub fn from_serializable_data(
        data: HashMap<String, LocalizationData>,
    ) -> Arc<LocalizationManager> {
...
impl Localization {
    ...
    pub async fn get(&self, key: &str) -> Option<String> {
        self.data.read().await.translations.get(key).cloned()
    }
    ...
    {
        self.data.write().await.translations.extend(iter)
    }
    ...
    pub async fn translation_map(&self) -> HashMap<String, String> {
        self.data.read().await.translations.clone()
    }
